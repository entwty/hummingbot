...
1. Fork the repo
1. Create a new branch from the [`development`](https://github.com/entwty/hummingbot/tree/development) branch (see: [branch naming guidelines](#branch-naming-guidelines))
1. Make commits to your branch
1. When you've finished with your fix or feature:
    - Rebase upstream changes into your branch
    - Submit a pull request to the [`development`](https://github.com/entwty/hummingbot/tree/development) branch
...
```
git remote add upstream https://github.com/entwty/hummingbot.git
```
